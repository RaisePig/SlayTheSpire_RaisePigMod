...
public class FeedingFrenzy extends CustomCard {
    public static final String ID = ModHelper.makePath(FeedingFrenzy.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractDungeon.actionManager.addToBottom(
                new ApplyPowerAction(p, p, new FeedingFrenzyPower(p, 1))
        );
    }
}
