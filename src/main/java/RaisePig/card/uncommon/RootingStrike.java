...
public class RootingStrike extends CustomCard {
    public static final String ID = ModHelper.makePath(RootingStrike.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        if (p.hasPower(RaisePigPower.POWER_ID)) {
            int amount = p.getPower(RaisePigPower.POWER_ID).amount;
