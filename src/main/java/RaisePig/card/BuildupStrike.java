...
public class BuildupStrike extends CustomCard {
    public static final String ID = ModHelper.makePath(BuildupStrike.class.getSimpleName());
    ...
    public void upgrade() {
        if (!this.upgraded) {
            ...
            this.upgradeMagicNumber(1); // 将该卡牌回复能量值提高1点。
